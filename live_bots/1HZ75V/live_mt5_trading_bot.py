...
MARKET_DIR = os.path.join(_REPO_ROOT, "markets", "1HZ75V")  # EDIT THIS per-market copy: change "1HZ25V" to match this instance's market
...
SYMBOL = "Volatility 75 (1s) Index"  # MT5 symbol name, used for live trading
HISTORICAL_DATA_SYMBOL_PREFIX = "1HZ75V"  # Deriv Options API symbol code, used for historical CSV filenames
...
FIXED_STAGE1_STOP_PCT = 0.344  # EDIT PER MARKET: validated via backtesting to consistently outperform the old 10-candle-range initial stop, across multiple recent windows (not just full-history average). 1HZ25V=0.057, 1HZ75V=0.344, 1HZ90V=0.417, 1HZ100V=0.476, R_100=0.463
MAX_TREND_STRENGTH_PCT = 0.7879  # EDIT PER MARKET: skip entries where price is further than this from the EMA (the "overextended" zone) -- validated via backtesting, this is each market's real tercile boundary where win rate consistently dropped. 1HZ25V=0.2838, 1HZ75V=0.7879, 1HZ90V=0.9165, 1HZ100V=1.0529, R_100=1.0407
