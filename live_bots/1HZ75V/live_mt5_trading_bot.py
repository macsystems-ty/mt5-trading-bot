...
MARKET_DIR    = os.path.join(_REPO_ROOT, "markets", "1HZ75V")  # EDIT per-market copy
...
SYMBOL                        = "Volatility 75 (1s) Index"  # EDIT per-market copy
HISTORICAL_DATA_SYMBOL_PREFIX = "1HZ75V"                    # EDIT per-market copy
STATUS_DIR = os.path.join(os.path.expanduser("~"), "mt5-trading-bot", "bot_status")

FIXED_STAGE1_STOP_PCT           = 0.344   # EDIT PER MARKET: 1HZ25V=0.057, 1HZ75V=0.344, 1HZ90V=0.417, 1HZ100V=0.476, R_100=0.463
MAX_TREND_STRENGTH_PCT          = 0.7879  # EDIT PER MARKET: 1HZ25V=0.2838, 1HZ75V=0.7879, 1HZ90V=0.9165, 1HZ100V=1.0529, R_100=1.0407
